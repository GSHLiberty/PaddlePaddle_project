...
yunjiaos = {'0': ['a', 'ia', 'ua', 'va', 'üa'], '1': ['e', 'o', 'uo', 'ie',
    'ue', 'üe', 've'], '2': ['u'], '3': ['i', 'ü', 'v'], '4': ['ai', 'uai'],
    '5': ['ao', 'iao'], '6': ['ou', 'iu', 'iou'], '7': ['an', 'ian', 'uan',
    'üan', 'van'], '8': ['en', 'in', 'un', 'ün', 'vn'], '9': ['ang', 'iang',
    'uang'], '10': ['eng', 'ing', 'ueng', 'ong', 'iong'], '11': ['er'],
    '12': ['ei', 'ui', 'uei', 'vei']}
yun2id = {}
...
def eval(res_file, fid):
    ...
    ugrams_ = []
    bigrams_ = []
    p_, r_, f1_ = 0.0, 0.0, 0.0
    n0_, n1_, n2_ = 0.0, 0.0, 0.0
    p__, r__, f1__ = 0.0, 0.0, 0.0
    n0__, n1__, n2__ = 0.0, 0.0, 0.0
    d1_, d2_ = 0.0, 0.0
    d4ends = []
    for x, y in docs:
    ...
    with open('./results_4ending/res4end' + str(fid) + '.txt', 'w') as fo:
        for line in d4ends:
            fo.write(line + '\n')
    return (tpl_macro_f1, tpl_micro_f1, rhy_macro_f1, rhy_micro_f1,
        macro_dist1, micro_dist1, macro_dist2, micro_dist2)


(tpl_macro_f1_, tpl_micro_f1_, rhy_macro_f1_, rhy_micro_f1_, macro_dist1_,
    micro_dist1_, macro_dist2_, micro_dist2_) = [], [], [], [], [], [], [], []
abalation = 'top-32'
for i in range(5):
    f_name = './results/new/' + abalation + '/out' + str(i + 1) + '.txt'
    if not os.path.exists(f_name):
        continue
    (tpl_macro_f1, tpl_micro_f1, rhy_macro_f1, rhy_micro_f1, macro_dist1,
        micro_dist1, macro_dist2, micro_dist2) = eval(f_name, i + 1)
