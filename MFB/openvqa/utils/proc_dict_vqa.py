...
import json
path = PATH()
stat_ans_list = json.load(open(path.RAW_PATH['vqa']['train-anno'], 'r'))[
    'annotations'] + json.load(open(path.RAW_PATH['vqa']['val-anno'], 'r'))[
    'annotations']
...
print(ans_to_ix)
json.dump([ans_to_ix, ix_to_ans], open(
    '../openvqa/datasets/vqa/answer_dict.json', 'w'))
