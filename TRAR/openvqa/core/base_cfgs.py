...
class BaseCfgs(PATH):
    ...
    def __init__(self):
        ...
        self.FEAT_SIZE = {'vqa': {'FRCN_FEAT_SIZE': (64, 2048),
            'BBOX_FEAT_SIZE': (100, 5)}, 'clevr': {'GRID_FEAT_SIZE': (196, 
            1024)}}
    ...
    def proc(self):
        ...
        self.TASK_LOSS_CHECK = {'vqa': ['bce', 'kld'], 'clevr': ['ce']}
