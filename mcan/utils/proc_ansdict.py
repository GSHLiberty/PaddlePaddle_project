...
ANSWER_PATH = {'train': DATASET_PATH +
    'v2_mscoco_train2014_annotations.json', 'val': DATASET_PATH +
    'v2_mscoco_val2014_annotations.json', 'vg': DATASET_PATH +
    'VG_annotations.json'}
stat_ans_list = json.load(open(ANSWER_PATH['train'], 'r'))['annotations'
